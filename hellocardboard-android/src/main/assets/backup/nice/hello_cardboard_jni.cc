...
Java_com_google_cardboard_VrActivity_nativeSetRobotPose(
    JNIEnv* /*env*/, jobject /*obj*/, jlong native_app, jint pose_index) {
  auto* app = reinterpret_cast<ndk_hello_cardboard::HelloCardboardApp*>(native_app);
  app->SetRobotPose(static_cast<int>(pose_index));
}
